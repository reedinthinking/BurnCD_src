...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedEjectWhenFinished();
	afx_msg void OnEnChangeVolume();
	afx_msg void OnStnClickedBufferText();
	afx_msg void OnNMCustomdrawProgress(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnStnClickedEstimatedTime();
	afx_msg void OnStnClickedProgressText();
};
